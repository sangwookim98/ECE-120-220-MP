...
INNERLOOP   ADD   R5,R5,R1            ; Increment sum						              
            ...
            LD    R5,RESET            ; Clear R5 (previous sum) to 0	
...
RESET      .FILL  x0000               ; Can be used to initialize registers			
CDOWN      .FILL  xFFFF               ; 2's complement of 1 (i.e. -1)				
